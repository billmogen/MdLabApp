package com.imaodou.mdlabapp.view;
...
public class RockerView extends View {
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        ...
        //回调模式
        mCallBackMode = getCallBackMode(typedArray.getInt(R.styleable.RockerView_rockerCallBackMode, 1));
        typedArray.recycle();
    }
